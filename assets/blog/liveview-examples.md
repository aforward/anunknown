...
| ![Phoenix Live Examples](/images/liveview-examples/phoenix_liveview_adventure_example.png) | A collection of examples including: thermostat, snake, autocomplete search, image editor, clock, pacman, rainbow, counter, "top", CRUD (users), presence | [Phoenix Live Examples Source](https://github.com/chrismccord/phoenix_live_view_example) |
